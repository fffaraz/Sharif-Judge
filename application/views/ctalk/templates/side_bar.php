...
<div id="side_bar" class="sidebar_open">
	<ul>
		...
		<div class="side_box">
			<a href="<?php echo site_url('registera') ?>"><li <?php echo ($selected=='registera'?'class="selected"':'') ?>><i class="splashy-folder_modernist_opened"></i><span class="sidebar_text"><?php t('Register Assignment'); ?></span></li></a>
		</div>
