...
<div id="top_bar">
	<div class="top_object shj_menu" id="user_top">
		...
		<div class="top_menu" id="user_menu">
			<a href="<?php echo site_url('profile') ?>"><div><?php t('Profile'); ?></div></a>
			<a href="<?php echo site_url('logout') ?>"><div><?php t('Logout'); ?></div></a>
		</div>
	</div>
	...
	<div class="top_object countdown" id="countdown">
		<div class="time_block">
			...
			<span class="time_label"><?php t('day'); ?></span><span class="time_label" id="days_label">s</span>
		</div>
		<div class="time_block">
			<span id="time_hours"></span><br>
			<span class="time_label"><?php t('hour'); ?></span><span class="time_label" id="hours_label">s</span>
		</div>
		<div class="time_block">
			<span id="time_minutes"></span><br>
			<span class="time_label"><?php t('minute'); ?></span><span class="time_label" id="minutes_label">s</span>
		</div>
		<div class="time_block">
			<span id="time_seconds"></span><br>
			<span class="time_label"><?php t('second'); ?></span><span class="time_label" id="seconds_label">s</span>
		</div>
	</div>
	<div class="top_object countdown" id="extra_time">
		<div class="time_block">
			<span><?php t('Extra'); ?></span><br><span><?php t('Time'); ?></span>
		</div>
	</div>
	<div id="shj_logo">
	...
	<div class="top_object shj_menu top_left" id="admin_tools_top">
		...
		<div class="top_menu" id="admin_tools_menu">
			...
			<a href="<?php echo site_url('moss/'.$assignment['id']) ?>"><div><?php t('Cheat Detection'); ?></div></a>
		</div>
	</div>
	<?php endif ?>
</div>