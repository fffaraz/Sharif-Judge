...
<div id="main_container">
	...
	<div id="main_content">
		<p><?php tt("You can use this field to add multiple users at the same time."); ?></p>
		<ul>
			<li><?php tt("Usernames may contain lowercase letters or numbers and must be between 3 and 20 characters in length."); ?></li>
			<li><?php tt("Passwords must be between 6 and 30 characters in length."); ?></li>
			<li><?php tt("If you want to send passwords by email, do not add too many users at one time. This may result in mail delivery fail."); ?></li>
		</ul>
		<p class="input_p">
